...
class ForecastDiffCallback : DiffUtil.ItemCallback<WeatherDetailEntity>() {
    override fun areItemsTheSame(oldItem: WeatherDetailEntity, newItem: WeatherDetailEntity): Boolean {
        return oldItem.id == newItem.id
    }

    override fun areContentsTheSame(oldItem: WeatherDetailEntity, newItem: WeatherDetailEntity): Boolean {
